...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Selección Múltiple de Especialidades y Días
    ...
    if (empty($nombre) || empty($correo) || empty($telefono) || empty($duracion)) {
        ...
        try {
            ...
            // 2. Insertar las especialidades seleccionadas en la tabla Pivot: psicologo_especialidad
            ...
            // 3. Insertar los Horarios de Atención
